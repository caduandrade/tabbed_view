...
class TabWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TabBordersThemeData bordersTheme = tabTheme.borders;
    final BorderSide borderSide = bordersTheme.border;
    final Radius? radius = bordersTheme.borderRadius > 0
        ? Radius.circular(bordersTheme.borderRadius)
        : null;
    BorderRadius? borderRadius;

    //TODO Experimental: Construction of all borders.
    // Many theming configurations.
    // Could everything be replaced with a decoration factory in each theme?

    switch (provider.tabBarPosition) {
      case TabBarPosition.top:
        // inner decoration near label
        widget = Container(
            decoration: BoxDecoration(
                border: Border(
                    bottom: bordersTheme.nearContent.label,
                    top: bordersTheme.farContent.label)),
            child: widget);
        // tab border
        if (radius != null) {
        ...
        widget = Container(
            decoration: BoxDecoration(
                border: Border(
                    bottom: bordersTheme.nearContent.middle,
                    top: bordersTheme.farContent.outer)),
            child: widget);
        break;
      case TabBarPosition.bottom:
        ...
        widget = Container(
            decoration: BoxDecoration(
                border: Border(
                    bottom: bordersTheme.farContent.label,
                    top: bordersTheme.nearContent.label)),
            child: widget);
        // tab border
        if (radius != null) {
          borderRadius =
        ...
        widget = Container(
            decoration: BoxDecoration(
                border: Border(
                    top: bordersTheme.nearContent.middle,
                    bottom: bordersTheme.farContent.outer)),
            child: widget);
        break;
      case TabBarPosition.left:
        ...
        widget = Container(
            decoration: BoxDecoration(
                border: Border(
                    right: bordersTheme.nearContent.label,
                    left: bordersTheme.farContent.label)),
            child: widget);
        // tab border
        if (radius != null) {
        ...
        widget = Container(
            decoration: BoxDecoration(
                border: Border(
                    right: bordersTheme.nearContent.middle,
                    left: bordersTheme.farContent.outer)),
            child: widget);
        break;
      case TabBarPosition.right:
        ...
        widget = Container(
            decoration: BoxDecoration(
                border: Border(
                    left: bordersTheme.nearContent.label,
                    right: bordersTheme.farContent.label)),
            child: widget);
        // tab border
        if (radius != null) {
          borderRadius =
        ...
        widget = Container(
            decoration: BoxDecoration(
                borderRadius: borderRadius,
                border: Border(
                    top: borderSide, right: borderSide, bottom: borderSide)),
            child: borderRadius != null
                ? ClipRRect(borderRadius: borderRadius, child: widget)
                : widget);
        // outer decoration
        widget = Container(
            decoration: BoxDecoration(
                border: Border(
                    left: bordersTheme.nearContent.middle,
                    right: bordersTheme.farContent.outer)),
            child: widget);
        break;
    }
