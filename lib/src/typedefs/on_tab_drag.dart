...
///
/// The [tabId] identifies the tab being detached.
///
...
///
/// The [tabId] identifies the tab being attached.
///
/// The tab must be inserted before the tab identified by [targetTabId].
/// If [targetTabId] is `null`, the tab must be inserted at the end.
///
